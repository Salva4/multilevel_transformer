...
if TYPE_CHECKING:
    ...
    from tranformers.generation.streamers import BaseStreamer
...
if is_assisted_gen_mode:
    ...
    outputs = self.assisted_decoding(
        input_ids,
...
if is_greedy_gen_mode:
    ...
    outputs = self.contrastive_search(
        input_ids,
    ...
    # 13. run beam search
    outputs = self.group_beam_search(
        input_ids,
        beam_scorer,
        logits_processor=logits_processor,
        stopping_criteria=stopping_criteria,
