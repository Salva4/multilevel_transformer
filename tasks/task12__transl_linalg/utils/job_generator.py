...
output_dir = 'continuous_transformer__20230402_01_task12_char'
task_path = '/users/msalvado/prova_transfpytorch/task12__langmod'
...
def text_(**kwargs):
  ...
  filename = f'ContTrans_nnodes{n_nodes}_ntasksxnode{n_tasksxnode}_proc{proc}_nlaysenc{n_lays_enc}_nlaysdec{n_lays_dec}'
...
srun python3 -u main_conv_char.py --lr {lr} --n_lays_enc {n_lays_enc} --n_lays_dec {n_lays_dec}
'''.strip()
  return t
